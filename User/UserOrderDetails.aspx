<%@ Page Language="C#" MasterPageFile="~/User/MasterPage/CommonMasterPage.master" AutoEventWireup="true" CodeFile="UserOrderDetails.aspx.cs" Inherits="User_UserOrderDetails" %>
    ...
    <table class="goodCart">
        <asp:DataList ID="orderList" runat="server" RepeatColumns="1" RepeatDirection="Horizontal" Width="100%" Style="background: #fff">
            <ItemTemplate>
                ...
                <tr>
                    <td>下单时间：<%#DataBinder.Eval(Container.DataItem, "OrderDate")%>
                    </td>
                </tr>
            </ItemTemplate>
        </asp:DataList>
        ...
        <asp:DataList ID="PayWayList" runat="server" RepeatColumns="1" RepeatDirection="Horizontal" Width="100%" Style="background: #fff" OnItemDataBound="PayWayList_OnItemDataBound">
            <ItemTemplate>
                <tr class="line" style="margin-top: 10px; margin-left: 40px;">
                    ...
                    <td style="padding: 0 10px;">运费：￥<span style="color: #f00"><%#DataBinder.Eval(Container.DataItem, "ShipFee")%></span>
                    </td>
                    ...
                    <td>
                     ...
                     <td>
                    <asp:LinkButton ID="exitMoney" runat="server" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "OrderID")%>' OnCommand="lnkbtnBackMoney_Command" Visible="false">退款</asp:LinkButton>
                    </td>
                    <td>
                    <asp:LinkButton ID="confrimRev" runat="server" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "OrderID")%>' OnCommand="lnkbtnConfrimRev_Command" Visible="false">确认收货</asp:LinkButton>
                    </td>
                    <td>
                    <asp:LinkButton ID="deleteOrder" runat="server" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "OrderID")%>' OnCommand="lnkbtnDeleteOrder_Command" Visible="false">删除订单</asp:LinkButton>
                    </td>
                </tr>
            </ItemTemplate>
        </asp:DataList>
