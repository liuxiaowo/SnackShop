<%@ Page Language="C#" MasterPageFile="~/Manager/MasterPage/CommonMasterPage.master" AutoEventWireup="true" CodeFile="ManagerChangeGoods.aspx.cs" Inherits="Manager_ManagerAddGoods" %>
...
<asp:Content ID="contentBuyCart" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
    ...
    <table style="margin-left:25%;">
        ...
        <tr  class="line" style="text-align:right">
            <td>
                销量：<asp:TextBox ID="salesnum" runat="server" style="border:1px solid" required="true"/>
                <span style="color: #ff0000" class="prompt">*</span>
            </td>
        </tr>
        <tr class="line" style="text-align:right">
        ...
        <tr class="line" style="text-align:center">
            <td>
                <asp:Button runat="server" Text="修改商品" CssClass="btn" OnClick="btn_OnClickChangeGoods"/>
            </td>
        </tr>
    </table>
</asp:Content>
